...
!(function (e, t) {
  ...
  !(function () {
    ...
    function s(s, i) {
      if (((this.el = s), (this.$el = e(s)), (this.s = e.extend({}, t, i)), this.s.dynamic && "undefined" !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && !this.s.dynamicEl.length))
    ...
    (s.prototype.init = function () {
      ...
      (s.prototype.isVideo = function (e, t) {
        var s;
        if (((s = this.s.dynamic ? this.s.dynamicEl[t].html : this.$items.eq(t).attr("data-html")), !e))
          return s
            ? { html5: !0 }
            : (console.error(
                "lightGallery :- data-src is not pvovided on slide item " + (t + 1) + ". Please make sure the selector property is properly configured. More info - http://sachinchoolur.github.io/lightGallery/demos/html-markup.html"
              ),
              !1);
        ...
        return i ? { youtube: i } : l ? { vimeo: l } : o ? { dailymotion: o } : n ? { vk: n } : void 0;
      }),
      ...
      (s.prototype.addHtml = function (t) {
        ...
        ".lg-sub-html" === this.s.appendSubHtmlTo ? (s ? this.$outer.find(this.s.appendSubHtmlTo).load(s) : this.$outer.find(this.s.appendSubHtmlTo).html(l)) : s ? this.$slide.eq(t).load(s) : this.$slide.eq(t).append(l),
      ...
      (s.prototype.loadContent = function (t, s, i) {
        ...
        if (g.s.dynamic) {
          ...
          if (
            (g.$items.eq(t).attr("data-poster") && ((h = !0), (n = g.$items.eq(t).attr("data-poster"))),
            (d = g.$items.eq(t).attr("data-html")),
            (o = g.$items.eq(t).attr("href") || g.$items.eq(t).attr("data-src")),
        ...
        if (!g.$slide.eq(t).hasClass("lg-loaded")) {
          if (c)
            g.$slide
              .eq(t)
              .prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + g.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + o + '"  allowfullscreen="true"></iframe></div></div>');
          else if (h) {
            var p = "";
            (p = m && m.youtube ? "lg-has-youtube" : m && m.vimeo ? "lg-has-vimeo" : "lg-has-html5"),
              g.$slide.eq(t).prepend('<div class="lg-video-cont ' + p + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + n + '" /></div></div>');
          } else
            m
              ? (g.$slide.eq(t).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), g.$el.trigger("hasVideo.lg", [t, o, d]))
              : g.$slide.eq(t).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + o + '" /></div>');
      ...
      (s.prototype.slide = function (t, s, i, l) {
        ...
        if (!n.lGalleryOn || o !== t) {
          ...
          if (!n.lgBusy) {
            ...
            if (this.s.download)
              (d = n.s.dynamic
                ? !1 !== n.s.dynamicEl[t].downloadUrl && (n.s.dynamicEl[t].downloadUrl || n.s.dynamicEl[t].src)
                : "false" !== n.$items.eq(t).attr("data-download-url") && (n.$items.eq(t).attr("data-download-url") || n.$items.eq(t).attr("href") || n.$items.eq(t).attr("data-src")))
                ? (e("#lg-download").attr("href", d), n.$outer.removeClass("lg-hide-download"))
            ...
            if (
              ...
              this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"),
                r > 2 ? ((g = t - 1), (h = t + 1), 0 === t && o === r - 1 ? ((h = 0), (g = r - 1)) : t === r - 1 && 0 === o && ((h = 0), (g = r - 1))) : ((g = 0), (h = 1)),
                "prev" === l ? n.$slide.eq(h).addClass("lg-next-slide") : n.$slide.eq(g).addClass("lg-prev-slide"),
                n.$slide.eq(t).addClass("lg-current");
            else
              n.$outer.addClass("lg-no-trans"),
                this.$slide.removeClass("lg-prev-slide lg-next-slide"),
                "prev" === l ? (this.$slide.eq(t).addClass("lg-prev-slide"), this.$slide.eq(o).addClass("lg-next-slide")) : (this.$slide.eq(t).addClass("lg-next-slide"), this.$slide.eq(o).addClass("lg-prev-slide")),
                setTimeout(function () {
            ...
            n.lGalleryOn
              ...
              : (n.loadContent(t, !0, n.s.backdropDuration), (n.lgBusy = !1), n.$el.trigger("onAfterSlide.lg", [o, t, s, i])),
              (n.lGalleryOn = !0),
      ...
      (s.prototype.setTranslate = function (e, t, s) {
        this.s.useLeft ? e.css("left", t) : e.css({ transform: "translate3d(" + t + "px, " + s + "px, 0px)" });
      }),
        ...
        t.s.enableDrag &&
          ...
          (t.$outer.on("mousedown.lg", function (i) {
            t.$outer.hasClass("lg-zoomed") ||
              t.lgBusy ||
              e(i.target).text() ||
              (i.preventDefault(), t.manageSwipeClass(), (s = i.pageX), (l = !0), (t.$outer.scrollLeft += 1), (t.$outer.scrollLeft -= 1), t.$outer.removeClass("lg-grab").addClass("lg-grabbing"), t.$el.trigger("onDragstart.lg"));
          }),
          e(window).on("mousemove.lg", function (e) {
            l && ((o = !0), (i = e.pageX), t.touchMove(s, i), t.$el.trigger("onDragmove.lg"));
          }),
          e(window).on("mouseup.lg", function (n) {
            o ? ((o = !1), t.touchEnd(i - s), t.$el.trigger("onDragend.lg")) : (e(n.target).hasClass("lg-object") || e(n.target).hasClass("lg-video-play")) && t.$el.trigger("onSlideClick.lg"),
      ...
      (s.prototype.destroy = function (t) {
        var s = this;
        t || (s.$el.trigger("onBeforeClose.lg"), e(window).scrollTop(s.prevScrollTop)),
          t && (s.s.dynamic || this.$items.off("click.lg click.lgcustom"), e.removeData(s.el, "lightGallery")),
          this.$el.off(".lg.tm"),
...
(function () {
  ...
  (i.getListeners = function (e) {
    ...
    (i.emitEvent = function (e, t) {
      ...
      for (r in s)
        if (s.hasOwnProperty(r)) for (i = s[r].length; i--; ) (n = s[r][i]), n.once === !0 && this.removeListener(e, n.listener), (o = n.listener.apply(this, t || [])), o === this._getOnceReturnValue() && this.removeListener(e, n.listener);
      return this;
    }),
...
!(function (t, e) {
  ...
  (t.fn.share = function (i) {
    ...
    (t.fn.share.defaults = { networks: ["reddit", "facebook", "twitter", "linkedin"], theme: "icon", autoShow: !0, margin: "3px", orientation: "horizontal", useIn1: !0 }),
    (t.fn.share.settings = {});
})(jQuery, window);
/** video**/
...
!(function (t) {
  ...
  (function (t) {
    t.fn.fitText = function (n, e) {
      var i = n || 1,
        r = t.extend({ minFontSize: Number.NEGATIVE_INFINITY, maxFontSize: Number.POSITIVE_INFINITY }, e);
      return this.each(function () {
        var n = t(this),
          e = function () {
            ...
            o(u, d) ||
              ...
              e.settings.useBothWheelAxes
                ? e.scrollbarYActive && !e.scrollbarXActive
                  ? (d ? l(t, "top", t.scrollTop - d * e.settings.wheelSpeed) : l(t, "top", t.scrollTop + u * e.settings.wheelSpeed), (a = !0))
                  : e.scrollbarXActive && !e.scrollbarYActive && (u ? l(t, "left", t.scrollLeft + u * e.settings.wheelSpeed) : l(t, "left", t.scrollLeft - d * e.settings.wheelSpeed), (a = !0))
          ...
          function b() {
            !Y &&
              ...
              (y = setInterval(function () {
                return o.get(t) ? (Math.abs(m.x) < 0.01 && Math.abs(m.y) < 0.01 ? void clearInterval(y) : (a(30 * m.x, 30 * m.y), (m.x *= 0.8), void (m.y *= 0.8))) : void clearInterval(y);
              }, 10)));
          }
          var v = {},
            g = 0,
          ...
          t.contains(e.scrollbarXRail) ||
            ...
            !e.settings.suppressScrollX && e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
              ? ((e.scrollbarXActive = !0),
                ...
                (e.scrollbarXLeft = s.toInt(((e.negativeScrollAdjustment + t.scrollLeft) * (e.railXWidth - e.scrollbarXWidth)) / (e.contentWidth - e.containerWidth))))
      ...
      function (t, e, n) {
        ...
        l.initEvent("ps-scroll-up", !0, !0),
          ...
          (e.exports = function (t, e, n) {
            ...
            var v = i.get(t);
            "top" === e && n >= v.contentHeight - v.containerHeight && ((t.scrollTop = n = v.contentHeight - v.containerHeight), t.dispatchEvent(b)),
              "left" === e && n >= v.contentWidth - v.containerWidth && ((t.scrollLeft = n = v.contentWidth - v.containerWidth), t.dispatchEvent(f)),
              r || (r = t.scrollTop),
              o || (o = t.scrollLeft),
...
!(function (e) {
  ...
  (n = {}),
      ...
      return (
        ...
        (a.initParams = function (t) {
          t && t.color && (!t.particle || (t.particle && !t.particle.color)) && (t.particle || (t.particle = {}), (t.particle.color = t.color)),
            (a.params = e.extend({ particlesNumber: 100, linkDist: 50, createLinkDist: 150, disableLinks: !1, disableMouse: !1, background: "black", color: "white", width: null, height: null, linksWidth: 1 }, t));
        }),
        ...
        (o = function (t, i) {
          ...
          return (
            ...
            (a.initialize = function (t, n) {
              (a.params = e.extend({ color: "white", minSize: 2, maxSize: 4, speed: 60 }, n)), a.setCanvasContext(t), a.initSize(), a.initPosition(), a.initVectors();
            }),
            ...
            (a.getPosition = function (e) {
              return "string" == typeof e && "x" != e && "y" != e && (e = null), "string" == typeof e ? a[e] : { x: a.x, y: a.y };
            }),
            a.initialize(t, i),
        ...
        a.initialize(t, i),
        { remove: a.remove, freeze: a.freeze, unfreeze: a.unfreeze, resize: a.resize }
      );
    }),
    ...
    (n.getMousePosition = function (t, n) {
      var i;
      return "undefined" == typeof n && (n = e("body")[0]), (i = n.getBoundingClientRect()), { x: t.clientX - i.left, y: t.clientY - i.top };
    });
})(jQuery);
/**
...
(function (e) {
  ...
  e.fn.shuffleLetters = function (n) {
    var r = e.extend({ step: 12, fps: 25, text: "", callback: function () {} }, n);
    return this.each(function () {
      var n = e(this),
        i = "";
      if (n.data("animated")) {
        ...
        s.byRow &&
          ...
          (h.each(function () {
            ...
            "inline-block" !== a && "inline-flex" !== a && (a = "block"),
              e.data("style-cache", e.attr("style")),
              e.css({ display: a, "padding-top": "0", "padding-bottom": "0", "margin-top": "0", "margin-bottom": "0", "border-top-width": "0", "border-bottom-width": "0", height: "100px", overflow: "hidden" });
          }),
          (c = i(h)),
          h.each(function () {
            var e = t(this);
        ...
        t.each(c, function (e, a) {
          ...
          i.each(function () {
            ...
            (s.target && e.is(s.target)) ||
              ("border-box" !== e.css("box-sizing") && ((a += o(e.css("border-top-width")) + o(e.css("border-bottom-width"))), (a += o(e.css("padding-top")) + o(e.css("padding-bottom")))), e.css(s.property, n - a + "px"));
          });
        }),
        d.each(function () {
          var e = t(this);
